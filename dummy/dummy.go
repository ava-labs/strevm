...
// actually used by Ethereum transaction execution. Although these are used in
// production and aren't test doubles, they effectively fill the same role as a
// dummy as described in https://martinfowler.com/bliki/TestDouble.html.
package dummy
...
// Engine returns a dummy that panics when its Author() method is called.
