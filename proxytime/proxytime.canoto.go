...
const (
	canoto__Time__seconds__tag  = "\x08" // canoto.Tag(1, canoto.Varint)
	canoto__Time__fraction__tag = "\x10" // canoto.Tag(2, canoto.Varint)
	canoto__Time__hertz__tag    = "\x18" // canoto.Tag(3, canoto.Varint)
)
...
func (*Time[T1]) MakeCanoto() *Time[T1] {
	return new(Time[T1])
}
